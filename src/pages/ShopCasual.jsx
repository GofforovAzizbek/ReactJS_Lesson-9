...
function ShopCasual() {
            ...
            {filterMeta.colors.map((color) => (
              <button
                ...
                className={`relative h-9 w-9 rounded-full border border-black/10 ${
                  colorFilter === color ? "ring-2 ring-black ring-offset-2" : ""
                }`}
  ...
  return (
    <section className="container py-8 sm:py-10">
      ...
      <div className="grid gap-4 xl:gap-5 lg:grid-cols-[230px_1fr]">
        ...
        <div>
          ...
          {loading ? (
            ...
            <>
              <div className="grid grid-cols-1 gap-x-4 gap-y-7 sm:grid-cols-3 xl:grid-cols-3">
                {pageItems.map((item) => (
